...
public class AutoHBMTimePreference extends CustomSeekBarPreference {
    ...
    public AutoHBMTimePreference(Context context, AttributeSet attrs) {
        ...
        mValue = Integer.parseInt(sharedPrefs.getString(HBMUtils.KEY_HBM_DISABLE_TIME, "1"));
    ...
    protected void changeValue(int newValue) {
        ...
        prefChange.putString(HBMUtils.KEY_HBM_DISABLE_TIME, String.valueOf(newValue)).apply();
    }
}
